...
legacy_void_exe!(cublasSgemmExe, cublasSgemm, (transa: c_char, transb: c_char, m: c_int, n: c_int, k: c_int, alpha: f32, A: *const f32, lda: c_int, B: *const f32, ldb: c_int, beta: f32, C: *mut f32, ldc: c_int));
legacy_void_exe!(cublasDgemmExe, cublasDgemm, (transa: c_char, transb: c_char, m: c_int, n: c_int, k: c_int, alpha: f64, A: *const f64, lda: c_int, B: *const f64, ldb: c_int, beta: f64, C: *mut f64, ldc: c_int));
legacy_void_exe!(cublasCgemmExe, cublasCgemm, (transa: c_char, transb: c_char, m: c_int, n: c_int, k: c_int, alpha: cuComplex, A: *const cuComplex, lda: c_int, B: *const cuComplex, ldb: c_int, beta: cuComplex, C: *mut cuComplex, ldc: c_int));
legacy_void_exe!(cublasZgemmExe, cublasZgemm, (transa: c_char, transb: c_char, m: c_int, n: c_int, k: c_int, alpha: cuDoubleComplex, A: *const cuDoubleComplex, lda: c_int, B: *const cuDoubleComplex, ldb: c_int, beta: cuDoubleComplex, C: *mut cuDoubleComplex, ldc: c_int));
legacy_void_exe!(cublasSsymmExe, cublasSsymm, (side: c_char, uplo: c_char, m: c_int, n: c_int, alpha: f32, A: *const f32, lda: c_int, B: *const f32, ldb: c_int, beta: f32, C: *mut f32, ldc: c_int));
legacy_void_exe!(cublasDsymmExe, cublasDsymm, (side: c_char, uplo: c_char, m: c_int, n: c_int, alpha: f64, A: *const f64, lda: c_int, B: *const f64, ldb: c_int, beta: f64, C: *mut f64, ldc: c_int));
legacy_void_exe!(cublasCsymmExe, cublasCsymm, (side: c_char, uplo: c_char, m: c_int, n: c_int, alpha: cuComplex, A: *const cuComplex, lda: c_int, B: *const cuComplex, ldb: c_int, beta: cuComplex, C: *mut cuComplex, ldc: c_int));
legacy_void_exe!(cublasZsymmExe, cublasZsymm, (side: c_char, uplo: c_char, m: c_int, n: c_int, alpha: cuDoubleComplex, A: *const cuDoubleComplex, lda: c_int, B: *const cuDoubleComplex, ldb: c_int, beta: cuDoubleComplex, C: *mut cuDoubleComplex, ldc: c_int));
legacy_void_exe!(cublasChemmExe, cublasChemm, (side: c_char, uplo: c_char, m: c_int, n: c_int, alpha: cuComplex, A: *const cuComplex, lda: c_int, B: *const cuComplex, ldb: c_int, beta: cuComplex, C: *mut cuComplex, ldc: c_int));
legacy_void_exe!(cublasZhemmExe, cublasZhemm, (side: c_char, uplo: c_char, m: c_int, n: c_int, alpha: cuDoubleComplex, A: *const cuDoubleComplex, lda: c_int, B: *const cuDoubleComplex, ldb: c_int, beta: cuDoubleComplex, C: *mut cuDoubleComplex, ldc: c_int));
legacy_void_exe!(cublasSsyrkExe, cublasSsyrk, (uplo: c_char, trans: c_char, n: c_int, k: c_int, alpha: f32, A: *const f32, lda: c_int, beta: f32, C: *mut f32, ldc: c_int));
legacy_void_exe!(cublasDsyrkExe, cublasDsyrk, (uplo: c_char, trans: c_char, n: c_int, k: c_int, alpha: f64, A: *const f64, lda: c_int, beta: f64, C: *mut f64, ldc: c_int));
legacy_void_exe!(cublasCsyrkExe, cublasCsyrk, (uplo: c_char, trans: c_char, n: c_int, k: c_int, alpha: cuComplex, A: *const cuComplex, lda: c_int, beta: cuComplex, C: *mut cuComplex, ldc: c_int));
legacy_void_exe!(cublasZsyrkExe, cublasZsyrk, (uplo: c_char, trans: c_char, n: c_int, k: c_int, alpha: cuDoubleComplex, A: *const cuDoubleComplex, lda: c_int, beta: cuDoubleComplex, C: *mut cuDoubleComplex, ldc: c_int));
legacy_void_exe!(cublasCherkExe, cublasCherk, (uplo: c_char, trans: c_char, n: c_int, k: c_int, alpha: f32, A: *const cuComplex, lda: c_int, beta: f32, C: *mut cuComplex, ldc: c_int));
legacy_void_exe!(cublasZherkExe, cublasZherk, (uplo: c_char, trans: c_char, n: c_int, k: c_int, alpha: f64, A: *const cuDoubleComplex, lda: c_int, beta: f64, C: *mut cuDoubleComplex, ldc: c_int));
legacy_void_exe!(cublasSsyr2kExe, cublasSsyr2k, (uplo: c_char, trans: c_char, n: c_int, k: c_int, alpha: f32, A: *const f32, lda: c_int, B: *const f32, ldb: c_int, beta: f32, C: *mut f32, ldc: c_int));
legacy_void_exe!(cublasDsyr2kExe, cublasDsyr2k, (uplo: c_char, trans: c_char, n: c_int, k: c_int, alpha: f64, A: *const f64, lda: c_int, B: *const f64, ldb: c_int, beta: f64, C: *mut f64, ldc: c_int));
legacy_void_exe!(cublasCsyr2kExe, cublasCsyr2k, (uplo: c_char, trans: c_char, n: c_int, k: c_int, alpha: cuComplex, A: *const cuComplex, lda: c_int, B: *const cuComplex, ldb: c_int, beta: cuComplex, C: *mut cuComplex, ldc: c_int));
legacy_void_exe!(cublasZsyr2kExe, cublasZsyr2k, (uplo: c_char, trans: c_char, n: c_int, k: c_int, alpha: cuDoubleComplex, A: *const cuDoubleComplex, lda: c_int, B: *const cuDoubleComplex, ldb: c_int, beta: cuDoubleComplex, C: *mut cuDoubleComplex, ldc: c_int));
legacy_void_exe!(cublasCher2kExe, cublasCher2k, (uplo: c_char, trans: c_char, n: c_int, k: c_int, alpha: cuComplex, A: *const cuComplex, lda: c_int, B: *const cuComplex, ldb: c_int, beta: f32, C: *mut cuComplex, ldc: c_int));
legacy_void_exe!(cublasZher2kExe, cublasZher2k, (uplo: c_char, trans: c_char, n: c_int, k: c_int, alpha: cuDoubleComplex, A: *const cuDoubleComplex, lda: c_int, B: *const cuDoubleComplex, ldb: c_int, beta: f64, C: *mut cuDoubleComplex, ldc: c_int));
legacy_void_exe!(cublasStrmmExe, cublasStrmm, (side: c_char, uplo: c_char, transa: c_char, diag: c_char, m: c_int, n: c_int, alpha: f32, A: *const f32, lda: c_int, B: *mut f32, ldb: c_int));
legacy_void_exe!(cublasDtrmmExe, cublasDtrmm, (side: c_char, uplo: c_char, transa: c_char, diag: c_char, m: c_int, n: c_int, alpha: f64, A: *const f64, lda: c_int, B: *mut f64, ldb: c_int));
legacy_void_exe!(cublasCtrmmExe, cublasCtrmm, (side: c_char, uplo: c_char, transa: c_char, diag: c_char, m: c_int, n: c_int, alpha: cuComplex, A: *const cuComplex, lda: c_int, B: *mut cuComplex, ldb: c_int));
legacy_void_exe!(cublasZtrmmExe, cublasZtrmm, (side: c_char, uplo: c_char, transa: c_char, diag: c_char, m: c_int, n: c_int, alpha: cuDoubleComplex, A: *const cuDoubleComplex, lda: c_int, B: *mut cuDoubleComplex, ldb: c_int));
legacy_void_exe!(cublasStrsmExe, cublasStrsm, (side: c_char, uplo: c_char, transa: c_char, diag: c_char, m: c_int, n: c_int, alpha: f32, A: *const f32, lda: c_int, B: *mut f32, ldb: c_int));
legacy_void_exe!(cublasDtrsmExe, cublasDtrsm, (side: c_char, uplo: c_char, transa: c_char, diag: c_char, m: c_int, n: c_int, alpha: f64, A: *const f64, lda: c_int, B: *mut f64, ldb: c_int));
legacy_void_exe!(cublasCtrsmExe, cublasCtrsm, (side: c_char, uplo: c_char, transa: c_char, diag: c_char, m: c_int, n: c_int, alpha: cuComplex, A: *const cuComplex, lda: c_int, B: *mut cuComplex, ldb: c_int));
legacy_void_exe!(cublasZtrsmExe, cublasZtrsm, (side: c_char, uplo: c_char, transa: c_char, diag: c_char, m: c_int, n: c_int, alpha: cuDoubleComplex, A: *const cuDoubleComplex, lda: c_int, B: *mut cuDoubleComplex, ldb: c_int));

...
pub mod cudart {
    ...
    impl std::fmt::Debug for cudaGraphNodeParams {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            f.debug_struct("cudaGraphNodeParams")
                .field("type_", &self.type_)
                .field("reserved0", &self.reserved0)
                .field("__bindgen_anon_1", &self.__bindgen_anon_1)
                .field("reserved2", &self.reserved2)
    ...
    impl std::fmt::Debug for cudaGraphNodeParams__bindgen_ty_1 {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            let reserved1 = unsafe { self.reserved1 };
            f.debug_struct("cudaGraphNodeParams__bindgen_ty_1")
                .field("reserved1", &reserved1)
                .finish()
        }
    }
